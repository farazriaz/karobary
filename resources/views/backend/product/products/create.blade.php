                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="weight" step="0.01" placeholder="0.00" required>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
								...
								<br/>
								<br/>
								<small class="text-muted" style="text-align:center;display:block;">-------OR---------</small>
								-->
    ...
    $(document).on('change', '[id^="category_id"]', function() {
        ...
        $.ajax({
            ...
            // /    var obj = JSON.parse(data);
                ...
                options += `<option value="">Select Subcategory ${categoryNumber-1}</option>`
                for(category of data.data){
                    options += `<option value="${category.id}">${category.name}</option>`
                }
                $(`#category${categoryNumber}`).append(`\
                <div class="form-group row" id="category${categoryNumber}">\
                            <label class="col-md-3 col-from-label">Subcategory ${categoryNumber-1}</label>\
                            <div class="col-md-8">\
                                <select class="form-control aiz-selectpicker" name="category_id${categoryNumber}" id="category_id${categoryNumber}" data-live-search="true" required>\                                                                                                        
                                ${options}
                                </select>\
                            </div>\
                        </div>\
